        <?php
            ...
            require_once "../Controller/populateFields.php";
            require_once "../Controller/ReloadDropdown.php";
        ?>
        <!DOCTYPE html>
        <head>
            ...
            <div class="container">
                ...
                <div class="form">
                    <table>
                        ...
                        <tr>
                            <?php  $result=getAllCategories();?>
                            <td class="field">
                                <select name="itemcatagory" id="itemcatagory" class="input">
                                    <option selected disabled hidden></option>
                                    <?php populateFields($result)?>
                                    <?php 
                                    $chosenCategory=reoloadCategory($_SESSION["itemcatagory"],$result);
                                    echo "<option value=".$chosenCategory['category_id']."selected>".$chosenCategory['category_name']."</option>";
                                    ?>
                                </select>
                        ...
                        <tr>
                            <td class="field">
                                <textarea placeholder="Enter description of the item" id="description" id="description" name="description">
                                    <?php 
