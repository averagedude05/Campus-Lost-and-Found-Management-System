...
elseif ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if ($flag) {
        ...
        if ($result['file_path']==0){
            ...
            insertNewLostItem(  $_SESSION['user_id'],$itemcatagory,$description,$founddate,$foundlocation,$result['file_path'],$itemnametxt);
            ...
            insertNewFoundItem(  $_SESSION['user_id'],$itemcatagory,$founddate,$foundlocation,$description,$result['file_path'],$itemnametxt);
            unset($_SESSION['itemtype']);
            unset($_SESSION['itemnametxt']);
            unset($_SESSION['itemcatagory']);
            unset($_SESSION['founddate']);
